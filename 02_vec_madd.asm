...
main:      # ************* Code starts here ***********
           ...
           addi $t2, $zero, 0x981963C5 		# Upper 32 bits of vector b       
           addi $t3, $zero, 0x5E80B36E		# Lower 32 bits of vector b
           addi $s0, $zero, 0			# Upper 32 bits of d = 0
           addi $s1, $zero, 0			# Lower 32 bits of d = 0
...
loop:                          
           ...
           slti $v0, $v1, 4			# Are we Lower32??
           beq $v0, $zero, lower32
           
	   ##  Upper32 bits 
	   and $t4, $t0, $t8			# Get byte for upper 32 bits of vector a
	   and $t5, $t2, $t8			# Get byte for upper 32 bits of vector b
...
skipReset:
	   and $t4, $t1, $t8			# Get byte for lower 32 bits of vector a
	   and $t5, $t3, $t8			# Get byte for lower 32 bits of vector b
	   add $t4, $t4, $t5
	   and $t4, $t4, $t8			# get only 1 byte from result
	   slt $v0, $t4, $t5 			# Check for Overflow
