...
main:      #Initializations
           ...
           addi $t0, $zero, 0x23051912		# Initialize lower 32 bits of vector a
           addi $t1, $zero, 0x120C1A0D 	        # Initialize upper 32 bits of vector a
           addi $t2, $zero, 0x057F192B		# Initialize lower 32 bits of vector b
           addi $t3, $zero, 0x3D0C104D 		# Initialize upper 32 bits of vector b       
           addi $t4, $zero, 0x501E0660		# Initialize lower 32 bits of vector c
           addi $t5, $zero, 0x60091B05		# Initialize upper 32 bits of vector c
           
           addi $t9, $zero, 24			# initial shifting value

loopUpper32:                      
           beq $v1, 4, exitLoopUpper32			
